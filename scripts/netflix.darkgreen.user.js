...
(function() {
	...
	var css = [
        ...
        ".nf-flat-button-primary,.nf-flat-button,.nf-svg-button-wrapper .nf-svg-button.simpleround,.nfDropDown.theme-lakira .label{ background-color: "+ bg_color +"!important; border-color: "+ main_color +"!important; color: "+ title_color +"!important;}",
        ...
        ".footer-top-a{ color: "+ subtitle +"!important; }",
