...
(function() {
	...
	var css = [
        ...
        "section.dashboard section.announcements article .wrapper section,body, button, input, select, textarea,summary-views_copy{ color: "+ subtitle +"!important; }",
        ...
        "#header nav li a,section.page > .container .highlight ul.earnings h4{ text-shadow: unset!important; }",
