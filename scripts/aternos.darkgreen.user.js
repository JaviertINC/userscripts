...
(function() {
	...
	var css = [
        ...
        ".server-ip,.btn.btn-huge.btn-green,.btn.btn-blue.btn-small.btn-clickme,.btn.btn-white.btn-small,.friend-access-small-button.friend-access-page.btn.btn-white,.btn.btn-white,.btn.btn-green{ background-color: #4c4c4c!important; border: 1px solid #4caf50!important; }",
